...
$title = "Final Project | Register Page | Introduction to Web Programming using PHP";
$description = "This is the Final Project for Introduction to Web Programming using PHP Course - Register Page";
...
<main class="container">
    ...
    <section class="form-row row justify-content-center">
        <form method="post" action="save-user.php" class="form-horizontal col-md-6 col-md-offset-3" enctype='multipart/form-data'>
            <!-- 1 -first_nameAD - TextBox -->
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-info col-md-2 col-md-offset-10" value="Submit">
                <p>&nbsp;</p>
            </div>
        </form>
